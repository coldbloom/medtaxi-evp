...
const reviews: ReviewItem[] = [
  {
    text:
      "Очень благодарны за помощь в перевозке мамы из больницы в Евпатории домой. Водитель Виталий внимательный, машина чистая, всё прошло быстро и аккуратно. Рекомендую!",
    author: "Мария, Евпатория",
  },
  {
    text:
      "Отличный сервис, сильные ребята Костя и Виталий подняли моего папу на 5ый этаж после выписки из поликлиники. Мы довольны и обратимся снова!",
    author: "Светлана, Евпатория",
  },
  {
    text:
